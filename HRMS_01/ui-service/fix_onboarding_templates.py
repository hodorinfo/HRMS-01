...
TEMPLATES_ROOT = "templates/onboarding"
...
def clean_file(filepath):
    ...
    # 2. Add specific basefilters for the onboarding module
...
def main():
    ...
    print(f"Sanitization complete. Updated {updated} out of {total} onboarding templates.")
