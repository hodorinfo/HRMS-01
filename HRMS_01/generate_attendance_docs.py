...
with open("/home/hodorinfo1/Downloads/HRMS_02/HRMS_01/attendance_openapi.json") as f:
    spec = json.load(f)

out = """# Attendance Service API Documentation
...
with open("/home/hodorinfo1/Downloads/HRMS_02/HRMS_01/attendance-service/ATTENDANCE_API_DOCS.md", "w") as f:
    f.write(out)
