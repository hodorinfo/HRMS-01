...
class Settings(BaseSettings):
    ...
    service_name: str = "horilla-attendance-service"
    debug: bool = False
    database_url: str = "postgresql+asyncpg://horilla:horilla@postgres:5432/horilla_attendance"
...
def get_settings() -> Settings:
    ...
    if settings.database_url.endswith("/horilla"):
        settings.database_url = settings.database_url[:-8] + "/attendance_db"
    return settings
